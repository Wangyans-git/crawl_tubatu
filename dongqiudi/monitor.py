...
start = time.time()
size = 0
path = "C:\\Users\\Administrator\\Desktop\\Test.exe"            # 路径
url = "https://dldir1.qq.com/qqtv/TencentVideo10.14.3360.0.exe"
response = requests.get(url,stream = True)         # stream参数设置成True时，它不会立即开始下载，当你使用
# iter_content或iter_lines遍历内容或访问内容属性时才开始下载
